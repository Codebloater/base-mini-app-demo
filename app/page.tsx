...
export default function Home() {
  ...
  return (
    <>
      <main className="flex flex-col items-center justify-between min-h-screen bg-[#0052FF]">
        <div className="flex flex-col items-center justify-between min-h-screen px-6 py-14 text-center">
          {/* Branding */}
